...
export function appendRenderedBody(
  parent: HTMLElement,
  el: Element,
  elementIds: Map<Element, string>,
  ctx: RenderCtx
...
function renderPicture(el: Element, elementIds: Map<Element, string>): HTMLElement {
  ...
  while (i < nodes.length) {
    ...
    if (tag === 'tabular') {
      const rendered = renderOtslContainer(node as Element, elementIds);
...
function renderList(el: Element, elementIds: Map<Element, string>): HTMLElement {
...
export function appendRenderedNode(
  parent: HTMLElement,
  node: ChildNode,
  elementIds: Map<Element, string>,
  ctx: RenderCtx
