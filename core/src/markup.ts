...
export function toggleTruncatableMarkupAttrValue(toggle: Element): void {
...
export function buildMarkupElement(
  el: Element,
  depth: number,
  elementIds: Map<Element, string>
): HTMLElement {
...
// ---------------------------------------------------------------------------
// Helpers used in buildMarkupView / appendMarkupVirtualText
// ---------------------------------------------------------------------------
...
export function buildMarkupView(
  segment: Element[],
  elementIds: Map<Element, string>,
